...
class GenerateurPDF {
  ...
  static const positionsAR = Positions(
    ...
    posHeure: Offset(-22, 95),
    posLieu: Offset(200, 80),
    posBlessesOui: Offset(349, 93),
    posBlessesNon: Offset(260, 93),
    posDegatsOui: Offset(-46, 135),
    posDegatsNon: Offset(-133, 135),
    posTemoins: Offset(290, 125), //Zone libre pour la liste des témoins

    //Véhicule A (colonne gauche)
    posA_assurance: Offset(-20, 195),
    posA_numContrat: Offset(-20, 215),
    posA_agence: Offset(-10, 233),
    posA_attestationDebut: Offset(-100, 266),
    posA_attestationFin: Offset(-10, 266),

    posA_nomConducteur: Offset(-10, 302),
    posA_prenomConducteur: Offset(-10, 320),
    posA_adresseConducteur: Offset(-10, 336),
    posA_numPermis: Offset(-10, 355),
    posA_datePermis: Offset(-25, 371),

    posA_nomAssure: Offset(-10, 407),
    posA_prenomAssure: Offset(-10, 424),
    posA_adresseAssure: Offset(-10, 440),
    posA_numTel: Offset(-25, 459),

    posA_marqueType: Offset(-5, 494),
    posA_numImmatriculation: Offset(-25, 512),
    ...
    //Véhicule B (colonne droite)
    posB_assurance: Offset(370, 195),
    posB_numContrat: Offset(370, 215),
    posB_agence: Offset(370, 234),
    posB_attestationDebut: Offset(270, 269),
    posB_attestationFin: Offset(370, 269),

    posB_nomConducteur: Offset(360, 302),
    posB_prenomConducteur: Offset(360, 320),
    posB_adresseConducteur: Offset(370, 337),
    posB_numPermis: Offset(370, 356),
    posB_datePermis: Offset(340, 372),

    posB_nomAssure: Offset(360, 406),
    posB_prenomAssure: Offset(360, 424),
    posB_adresseAssure: Offset(370, 442),
    posB_numTel: Offset(340, 460),

    posB_marqueType: Offset(370, 493),
    posB_numImmatriculation: Offset(360, 511),
    posB_sensSuivi: Offset(360, 528),
    posB_venantDe: Offset(360, 547),
    posB_allantA: Offset(360, 563),
    posB_pointChoc: Offset(460, 614),

    posB_degatsApparents: Offset(370, 717),
    posB_observations: Offset(370, 753),
